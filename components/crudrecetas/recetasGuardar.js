...
export default function GuardarReceta({navigation}){
    ...
    const pressHandler = async () => {
        if( descripcion.length <=0  ){
            ...
            try{
                const respuesta = await fetch(ip.ip + "recetas/guardar",
                    {
                        method: 'POST',
                        headers:{
                ...
                console.log(json);
                Alert.alert("SorBurgers", "Nueva Receta Guardado Correctamente");
        ...
        <View style={styles.container}>
            <View style={styles.signup}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Guardar un a Receta</Text>
                </View>
