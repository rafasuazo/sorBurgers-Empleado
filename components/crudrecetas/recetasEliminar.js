...
export default function EliminarReceta ({route, navigation}) {
    ...
    const presseliminar = async () => {
        if(!id){
            ...
            try {
                const response = await fetch(ip.ip + "recetas/eliminar?id=" + id,
                {
                    method: 'DELETE',
                    headers: {
        ...
        Alert.alert("SorBurgers", "Receta Eliminado Correctamente");
        ...
        <View style={styles.container}>
            <View style={styles.signup}>
                <View style={styles.titleContainer}>
                    <Text style={styles.title}>Eliminar una Receta</Text>
                </View>
